...
export const BadgeCard: React.FC<BadgeCardProps> = ({ badge, onViewOnLedger, onCollect }) => {
  ...
  return (
    <div
      className={`group relative overflow-hidden rounded-xl transition-all duration-500 transform hover:scale-[1.02] border-2 ${getBackgroundColor()} ${getBorderColor()} hover:shadow-xl`}
    >
      {/* Badge Container */}
